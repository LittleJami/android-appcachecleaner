package com.panruyiapp.accessibility.appcachecleaner.ui.activity
...
import com.panruyiapp.accessibility.appcachecleaner.const.Constant.Bundle.AppCacheCleanerActivity.Companion.KEY_SKIP_FIRST_RUN
import com.panruyiapp.accessibility.appcachecleaner.databinding.ActivityMainBinding
import com.panruyiapp.accessibility.appcachecleaner.log.Logger
import com.panruyiapp.accessibility.appcachecleaner.placeholder.PlaceholderContent
import com.panruyiapp.accessibility.appcachecleaner.service.CacheCleanerTileService
import com.panruyiapp.accessibility.appcachecleaner.ui.dialog.AlertDialogBuilder
import com.panruyiapp.accessibility.appcachecleaner.ui.dialog.CustomListDialogBuilder
import com.panruyiapp.accessibility.appcachecleaner.ui.dialog.FilterListDialogBuilder
import com.panruyiapp.accessibility.appcachecleaner.ui.dialog.IgnoreAppDialogBuilder
import com.panruyiapp.accessibility.appcachecleaner.ui.dialog.PermissionDialogBuilder
import com.panruyiapp.accessibility.appcachecleaner.ui.fragment.HelpFragment
import com.panruyiapp.accessibility.appcachecleaner.ui.fragment.PackageListFragment
import com.panruyiapp.accessibility.appcachecleaner.ui.fragment.SettingsFragment
import com.panruyiapp.accessibility.appcachecleaner.util.ActivityHelper
import com.panruyiapp.accessibility.appcachecleaner.util.ExtraSearchTextHelper
import com.panruyiapp.accessibility.appcachecleaner.util.IIntentActivityCallback
import com.panruyiapp.accessibility.appcachecleaner.util.LocalBroadcastManagerActivityHelper
import com.panruyiapp.accessibility.appcachecleaner.util.LocaleHelper
import com.panruyiapp.accessibility.appcachecleaner.util.PackageManagerHelper
import com.panruyiapp.accessibility.appcachecleaner.util.PermissionChecker
import com.panruyiapp.accessibility.appcachecleaner.util.TileRequestResult
...
class AppCacheCleanerActivity : AppCompatActivity(), IIntentActivityCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (calculationCleanedCacheJob?.isActive != true)
            updateMainText(intent.getCharSequenceExtra(ARG_DISPLAY_TEXT),true)
    ...
    private fun updateMainText(text: CharSequence?,interrupted :Boolean) {
        runOnUiThread {
            binding.textView.text = text
            if(!text.isNullOrEmpty())
            {
                binding.textViewcard.visibility = View.VISIBLE
                if(!interrupted)showClearResultDialog(this,text.toString())
            }
        }
    }

    private fun showClearResultDialog(context: Context, message: String)
    {
        val builder = AlertDialog.Builder(this)
        builder.setTitle(R.string.app_name)
            .setIcon(R.mipmap.ic_launcher)
            .setMessage(message)
            .setPositiveButton(R.string.dialog_extra_search_text_btn_ok,null)
    ...
    override fun onCleanCacheFinish(interrupted: Boolean,
        ...
        updateMainText(displayText,true)
    ...
    private suspend fun calculateCleanedCache(interrupted: Boolean) {
        ...
        calculationCleanedCacheJob?.invokeOnCompletion { throwable ->
            if (throwable == null) {
                ...
                updateMainText(displayText,interrupted)
            }
        }
    }
